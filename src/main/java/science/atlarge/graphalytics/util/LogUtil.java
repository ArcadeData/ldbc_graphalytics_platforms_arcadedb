...
/**
 * Replaces graphalytics-core's LogUtil, which was compiled against a log4j-core
 * version whose {@code ConsoleAppender.createAppender} factory signature no longer
 * exists in log4j-core 2.26.1. This class must keep the same fully-qualified name
 * as the upstream one so it takes precedence in the shaded jar.
 */
public class LogUtil {
    ...
    public static void appendSimplifiedConsoleLogger(Level level) {
        ...
        Appender appender = ConsoleAppender.createAppender(layout, null, ConsoleAppender.Target.SYSTEM_OUT, "stdout", true, false, true);
        appender.start();
