#!/usr/bin/env python3
"""
LDBC Graphalytics Benchmark: ArcadeDB (Docker) vs Kuzu vs DuckPGQ vs Memgraph vs Neo4j vs ArangoDB vs FalkorDB vs HugeGraph vs SurrealDB
...
# SurrealDB lacks built-in graph algorithms and multi-hop traversal — all
# metrics return N/A. Still available via: python3 benchmark.py surrealdb
